            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <ul class="bxslider">
                        <li>
                            <h3>Welcome to</h3>
                            <h2>The<span class="highlight">BEST</span> Bootstrap Template</h2>
                            <p>
                        ...
                        <li>
                            <h3>This Template</h3>
                            <h2>Suits for <span class="highlight">any Needs</span></h2>
                            <p>
                                <a href="#" class="theme_btn">Know More</a>
                            </p>
                        </li>
...
?>
    <section id="preinfo" class="light_section">
        <div class="container">
            <div class="row">
                <h2 class="block-header text-center">All <strong>Power</strong> of Twitter <strong>Bootstrap</strong></h2>

                
                <div class="col-sm-3">
                    <img src="example/bootstrap.jpg" alt="">
                </div>
                <div class="col-sm-9">
                    <h3>Ultra responsive. Working on any devices</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita quia rem, explicabo iste. Voluptas, ea, vel. Quam ullam deserunt tenetur dignissimos pariatur. Nobis quia temporibus est neque harum accusantium, eum.</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia, dicta eius voluptatem impedit beatae, nihil nostrum perferendis mollitia laboriosam possimus adipisci fuga molestias porro magni doloremque nisi quasi aliquam esse!</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia, dicta eius voluptatem impedit beatae, nihil nostrum perferendis mollitia laboriosam possimus adipisci fuga molestias porro magni doloremque nisi quasi aliquam esse!</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae cum sequi accusamus magni, eius maiores eat.</p>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="block col-sm-3">
                    ...
                    <p>
                        Stet clita kasd gubergren, no sela takimata sanctus est lorem ipsum dolor sit amet lorem ipsum dolor amet consetetur sadipscing elitr.
                    </p>
                </div>
